...
public class CoachingPanel : MonoBehaviour
{
    ...
    private static readonly string[][] pages = new string[][]
    {
        ...
        new string[]
        {
            ...
            "",
            "Alt: radial Page 2 -> EE Lock (releases",
            "the gripper briefly to select).",
        },
