...
| `holoassist_perception` | 0.1.0 | `src/HoloAssist_Perception` | HoloAssist team (custom) | real/sim perception, cube pose fusion, debug image, and custom pick/place interfaces |
| `holoassist_movement` | 0.1.0 | `src/HoloAssist_Movement` | HoloAssist team (custom) | MoveIt execution, workspace scene, pick/place sequencer, and custom TargetRPY message |
...
1. `holoassist_perception` (`HoloAssist_Perception`)
- consumes camera streams + AprilTag detections
- publishes `/holoassist/perception/april_cube_{1..4}_pose`
- publishes debug image `/holoassist/perception/debug_image`
...
| Motion planning | `holoassist_movement`, `ur_onrobot_moveit_config` |
| Real perception | `holoassist_perception`, `apriltag_ros`, `realsense2_camera` |
| Sim perception/fallback | `holoassist_perception` |
