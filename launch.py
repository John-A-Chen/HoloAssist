...
SOURCE_CMD = (
    ...
    f" && if [ -f {MAIN_WS}/install/setup.bash ]; then source {MAIN_WS}/install/setup.bash; fi"
...
def main():
    ...
    if args.moveit:
        ...
        view_robot_rviz = os.path.join(
            ROS2_WS,
            "install/moveit_robot_control/share"
            "/moveit_robot_control/rviz/view_robot.rviz",
        )
        moveit_cmd = (
