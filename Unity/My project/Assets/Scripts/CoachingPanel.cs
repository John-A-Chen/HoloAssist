...
public class CoachingPanel : MonoBehaviour
{
    ...
    private static readonly string[][] pages = new string[][]
    {
        ...
        new string[]
        {
            "RMRC - CARTESIAN MODE",
            "",
            "X Button ...... Translate <-> Rotate",
            "(or radial -> RMRC Mode)",
            "",
            "TRANSLATE sub-mode (default):",
        ...
        new string[]
        {
            "GRIPPER + EE LOCK",
            "",
            "EITHER trigger drives the gripper",
            "(analog, 0-100%). Held = closed,",
            "release = open. Works in all modes.",
            "",
            "PREFERRED: use the LEFT TRIGGER for",
            "gripping. This keeps the RIGHT TRIGGER",
            "free for radial menu selection, so you",
            "can hold a cube AND operate the radial",
            "menu without dropping it.",
            "",
            "L Stick Click .. Toggle EE Lock-Down",
            "  Press straight down on left thumbstick.",
            "  Works MID-GRIP — keep your grip trigger",
            "  held while clicking; cube stays held.",
            "",
            "EE Lock aims tool straight down so you",
            "can translate freely to a bin without",
            "re-orienting the wrist.",
            "",
            "Alt: radial Page 2 -> EE Lock.",
        },
        ...
        new string[]
        {
            ...
            "",
            "Press Y to open / close. Point with",
            "right controller; pull Right Trigger",
            "to select.",
            "",
            "Page 1 - UI panels:",
