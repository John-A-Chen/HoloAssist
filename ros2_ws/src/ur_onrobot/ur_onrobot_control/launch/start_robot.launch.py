    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            description=(
                ...
                "Extract from the physical robot with: "
                "ros2 launch ur_calibration calibration_correction.launch.py "
                "robot_ip:=<IP> target_filename:=<path/to/ur3e_calibration.yaml>. "
                "Replace the placeholder in ur_onrobot_description/config/ur3e_calibration.yaml "
                "and rebuild to make this the permanent default."
            ),
        )
    )
    declared_arguments.append(
